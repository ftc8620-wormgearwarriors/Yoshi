...
import com.example.trajectoryactions.wgwBasketSamples;
...
@Config
@Autonomous
public final class FerbBasketSample extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        wgwBasketSamples ab = new wgwBasketSamples(ferb.driveTrain);
        ...
        Actions.runBlocking(ab.basketSamples(ferb.driveTrain,
                ferb.arm.claw.deliverSample(),
                ferb.arm.claw.pickupSampleAction(),
                ferb.arm.armToPickUp(),
                ferb.arm.armToHighBasket(),
                ferb.arm.slideToHighBasket(),
                ferb.arm.armToAscent1(),
                ferb.arm.slideToPickUp(),
                ferb.arm.armToSafety(),
                ferb.arm.armWhenDriving()));
