...
@Config
@Autonomous
public final class FerbFourSpecimen extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        wgwFourSpecimen ab = new wgwFourSpecimen(ferb.driveTrain);
        ...
        Actions.runBlocking(ab.fourSpecimen(ferb.driveTrain,
