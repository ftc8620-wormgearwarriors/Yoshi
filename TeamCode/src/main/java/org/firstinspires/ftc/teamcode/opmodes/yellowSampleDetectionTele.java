...
@Config
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name="YellowSampleDetectionTeleOp")
public class yellowSampleDetectionTele extends OpMode {
    ...
    public void loop() {
        ...
        if (gamepad1.b) {
            ferb.sampleAutoTargeting(telemetry);
        }
